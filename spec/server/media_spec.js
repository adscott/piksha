  ...
  describe('after fetching content', function () {
    ...
    describe('when reading albums', function () {
      ...
      it('should assign a thumbnail', function () {
        expect(albums[0].thumbnail).toBe('https://farm21.staticflickr.com/100/1_secret1_q.jpg');
      });

      it('should assign a title', function () {
        expect(albums[0].title).toBe('A sample set');
      });
    ...
    describe('when reading an album', function () {
      ...
      it('should assign a title', function () {
        expect(album.title).toBe('A sample set');
      });
      ...
      it('should assign a thumbnail to photos', function () {
        expect(album.photos[0].thumbnail).toBe('https://farm21.staticflickr.com/100/1_secret1_q.jpg');
      });
      ...
      it('should assign a url to photos', function () {
        expect(album.photos[0].url).toBe('/api/photos/1');
      });
    });
    ...
    describe('when reading a photo', function () {
      ...
      beforeEach(function (done) {
        media.readPhoto('1').then(function (photoRead) {
          photo = photoRead;
          done();
        });
      });
      ...
      it('should assign a thumbnail to photos', function () {
        expect(photo.thumbnail).toBe('https://farm21.staticflickr.com/100/1_secret1_q.jpg');
      });

      it('should assign a full image to photos', function () {
        expect(photo.full).toBe('https://farm21.staticflickr.com/100/1_secret1_b.jpg');
      });
